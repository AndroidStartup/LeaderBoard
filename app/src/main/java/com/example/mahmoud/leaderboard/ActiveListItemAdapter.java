...
public class ActiveListItemAdapter extends FirebaseListAdapter<ShoppingListItem> {
    ...
    protected void populateView(View view, final ShoppingListItem item, int position) {
        ...
        TextView textViewMealItem = (TextView) view.findViewById(R.id.text_view_active_list_item_name);
        TextView textView = (TextView) view.findViewById(R.id.text_view_bought_by_user);

        textViewMealItem.setText(item.getItem());
        textView.setText("By: " + item.getOwner());
        ...
        buttonRemoveItem.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(mActivity)
                        ...
                        .setMessage("are you sure remove")
